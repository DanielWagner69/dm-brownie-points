...
/** Who this library action can be raised against (absolute to the couple). */
export type ActionAppliesTo = "both" | "user_a" | "user_b";
...
export type ActionType = {
  ...
  is_default: boolean;
  archived: boolean;
  /** Absolute: both partners, or only user_a / user_b of the couple. */
...
export type LoggedAction = {
  ...
  logged_by: string;
  applies_to: string;
  /** Who performed / is tagged. "both" kept for legacy history colouring. */
  ...
  note: string;
  /** Soft reply from the other partner */
