...
import { clampBasePoints, cn, formatPoints, resizeImageFile } from "@/lib/utils";
...
/** Map absolute applies_to (user_a/user_b/both) to relative me/them/both for the current user. */
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <input
                    ...
                    onChange={async (e) => {
                      ...
                      if (!f) return;
                      try {
                        const data = await resizeImageFile(f);
                        setPhoto(data);
                      } catch {
