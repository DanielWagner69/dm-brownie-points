        ...
        {selected ? (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div
              ...
              aria-hidden
            />
            <Card className="relative z-10 w-full max-w-md max-h-[90dvh] overflow-y-auto border-primary/30 shadow-xl">
              <CardHeader className="relative pr-12">
                <button
                  type="button"
                  onClick={() => setSelected(null)}
                  className="absolute right-3 top-3 flex h-9 w-9 items-center justify-center rounded-full border border-border bg-surface text-muted-foreground hover:bg-muted hover:text-foreground"
                  aria-label="Close"
                >
                  ✕
                </button>
