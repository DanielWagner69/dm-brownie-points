...
import { Bell, BellOff, ChevronDown, ChevronRight, Cloud, Flame, Flower2, Grape, LogOut, Moon, Plane, Pencil, Sun, Trash2 } from "lucide-react";
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          try {
                            ...
                            setEditingCat(null);
                            toast.success("Group renamed — actions updated");
                            invalidate();
                          } catch (e) {
        ...
        <Card>
          ...
          >
            ...
            <CardDescription>
              ...
              {!openActions ? (
                <span className="mt-1 block text-primary">
                  {(actionTypes.data ?? []).length} action{(actionTypes.data ?? []).length === 1 ? "" : "s"} · tap to expand
                </span>
              ) : null}
            </CardDescription>
          </CardHeader>
