import { A as email, B as base64Url, Bt as ATTR_OPERATION_ID, C as toResponse, D as any, F as record, Gt as queueAfterTransactionHook, H as decodeJwt, Ht as safeJSONParse, I as string, Jt as getBetterAuthVersion, Kt as runWithAdapter, Lt as withSpan, M as number, N as object, O as array, P as optional, Qt as createRandomStringGenerator, Rt as ATTR_CONTEXT, S as serializeSignedCookie, Tt as JWTExpired, U as decodeProtectedHeader, Ut as getAuthTables, Vt as import_src, W as jwtVerify, Wt as getCurrentAdapter, Xt as initGetFieldName, Yt as initGetModelName, Zt as generateId, _ as runWithRequestState, _n as kAPIErrorHeaderSymbol, a as createAuthorizationURL, an as createLogger, b as createRouter$1, c as createRateLimitKey, d as deprecate, f as createAuthEndpoint, fn as isDevelopment, g as hasRequestState, gn as BetterAuthError, h as defineRequestState, hn as APIError, i as refreshAccessToken, in as normalizePathname, j as looseObject, k as boolean, l as findInvalidTrustedProxies, ln as env, m as isAPIError, mn as isTest, n as socialProviders, o as applyDefaultAccessTokenExpiry, on as logger, p as createAuthMiddleware, pn as isProduction, pt as encode, qt as runWithTransaction, r as validateAuthorizationCode, s as isLoopbackHost, sn as shouldPublishLog, t as SocialProviderListEnum, tn as betterFetch, u as getIp, v as getCurrentAuthContext, vn as BASE_ERROR_CODES, w as filterOutputFields, x as serializeCookie, y as runWithEndpointContext, zt as ATTR_HOOK_TYPE } from "../_libs/@better-auth/core+[...].mjs";
...
import { i as getPglite, r as ensureDbReady } from "./db-BWLI4Tr_.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/server-Duk20QHo.js
...
*
* Pre-wired for live preview + deploy — keep structure intact.
* Small production fixes only: serverless pool, cookie OAuth state,
* and `*.grok.me` hosts for published apps when BETTER_AUTH_URL is unset.
*/
ensureDbReady();
...
var trustedOrigins = explicitBaseURL ? [
	explicitBaseURL,
	...LOCAL_DEV_ORIGINS,
	"https://*.grok.me",
	"https://*.vercel.app"
...
var database = databaseUrl ? globalAuthRef.__grokAuthPool__ ??= new Pool({
